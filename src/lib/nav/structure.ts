...
export const NAV: NavSection[] = [
  // ─── 1. Operations / Dashboard ──────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'forecast', href: '/pos/forecast', label: 'Прогноз спроса', icon: TrendingUp, desc: 'AI-прогноз выручки и SKU', badge: 'new' },
  ...
  // ─── 3. Kitchen / KDS ───────────────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'cooking-plan', href: '/pos/cooking-plan', label: 'План готовки', icon: ChefHat, desc: 'Дневной план блюд', badge: 'new' },
  ...
  // ─── 8. Finance / Cash / Salary ─────────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 'refunds', href: '/pos/refunds', label: 'Возвраты', icon: CreditCard, desc: 'История и оформление возвратов', badge: 'new' },
