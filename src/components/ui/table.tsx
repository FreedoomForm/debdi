...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t border-border bg-muted/50 text-foreground last:[&>tr]:border-b-0",
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-border transition-colors duration-100 text-foreground bg-transparent hover:bg-muted/50 data-[state=selected]:bg-muted",
        className,
      )}
      {...props}
    />
