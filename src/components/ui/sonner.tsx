  ...
  return (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast:
            "bg-card text-foreground border-border border font-base shadow-[var(--shadow-lg)] rounded-xl text-[13px] flex items-center gap-2.5 p-4 w-[356px] [&:has(button)]:justify-between",
